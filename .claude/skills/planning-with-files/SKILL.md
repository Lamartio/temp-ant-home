...
Prefix feature files with padded numbers:
- `001-feature-a.md`
- `002-feature-b.md`
- `003-bug-fix.md`

Ensures sort order, easy navigation, clear sequence.
...
### 6. Conciseness Over Grammar
Sacrifice grammar for brevity. Skip articles, use fragments, omit obvious words. Files = working memory, not prose.
